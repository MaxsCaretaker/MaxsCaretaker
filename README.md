```
╔══════════════════════════════════════════════════════════════════╗
║              PROFILE · MAXSCARETAKER · v2.4                      ║
╠══════════════════════════════════════════════════════════════════╣
║  OPERATOR  : NUNEZ, SERGIO                                       ║
║  CALLSIGN  : MaxsCaretaker                                       ║
║  BASE      : Riverside, CA · CSUSB CE '24                        ║
...
────  ──────────────────────────────────  ──────────────  ─────────────────────────────
P-01  AUTONOMOUS PERIMETER SURVEILLANCE  ● ACTIVE BUILD  RPi4 · PIR · Ultrasonic · Cam
P-02  IT-ACTIVE-DIRECTORY                ✓ DEPLOYED      Azure AD · PowerShell
P-03  FLIGHT-TRACKER                     ✓ LIVE          Flask · AviationStack · Render
